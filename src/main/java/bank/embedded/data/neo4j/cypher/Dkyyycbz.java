 ...
 *
 */
public class Dkyyycbz extends Cypher{
	private String cypher1="match P=(:B)-[dk:DK]->(ckzh:CK:Com)-[jy:JY]->(jyds:CK)<-[:DY]-(n:N)-[:DY]->(zh:CK)<-[dk_new:DK]-(:B)\r\n" + 
			...
			"return P  \r\n";
	private String cypher2="match P=(:B)-[dk:DK]->(ckzh:CK:Com)-[jy1:JY]->(:CK)-[jy2:JY]->(jyds:CK)<-[:DY]-(n:N)-[:DY]->(zh:CK)<-[dk_new:DK]-(:B)\r\n" + 
			...
			"and toInteger(dk_new.dksjffrq_sj)-toInteger(dk.dksjffrq_sj)>0\r\n" + 
			"return P  \r\n" ;
	private String cypher3="match P=(:B)-[dk:DK]->(ckzh:CK:Com)-[jy1:JY]->(:CK)-[jy2:JY]->(:CK)-[jy3:JY]->(jyds:CK)<-[:DY]-(n:N)-[:DY]->(zh:CK)<-[dk_new:DK]-(:B)\r\n" + 
			"where jy1.jyje>=dk.je*0.8 and jy1.jyje<=dk.je*1.2 \r\n" + 
			"and jy2.jyje>=dk.je*0.8 and jy2.jyje<=dk.je*1.2\r\n" + 
	...
	private String patternName="dkyyycbz";
