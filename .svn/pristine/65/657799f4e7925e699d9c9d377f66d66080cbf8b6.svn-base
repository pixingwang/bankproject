...
var render=function(){
		...
		//进入圆形			
		   var node=noded.enter()
					...
					.attr("fill",function(d){
					  return (d.label=="B")?"#ff0000":(d.label=="P")?"#ff68fb":(d.label=="C")?"#37ff00":"#fff50d";
					})
					.on("mouseup",function(d){mouseup(d);})
					.on("mousedown",function(d){
						mousedown(d);
						switch(d.label){
							case "B":$("#nodeInfo").html("<tr><td width='75px'>银行</td><td width='120%'>"+d.yxjgmc+"</td><td width='75px'>银行机构代码</td><td width='120%'>"+d.yxjgdm+"</td></tr>" +
											"<tr><td>内部机构号</td><td>"+d.nbjgh"</td><td>金融许可证号</td><td>"+d.jrxkzh+"</td></tr>" +
											"<tr><td>机构类别</td><td>"+d.jglb+"</td><td>邮政编码</td><td>"+d.yzbm+"</td></tr>" +
											"<tr><td>网点号</td><td>"+d.wdh+"</td><td>营业状态</td></tr>"+d.yyzt+"</td></tr>" +
											"<tr><td>成立时间</td><td>"+d.clsj+"</td><td>机构工作开始时间</td><td>"+d.jggzkssj+"</td></tr>" +
											"<tr><td>机构工作终止时间</td><td>"+d.jggzzzsj+"</td><td>机构地址</td><td>"+d.jgdz+"</td></tr>" +
											"<tr><td>负责人姓名</td><td>"+d.fzrxm+"</td><td>负责人职务</td><td>"+d.fzrzw+"</td></tr>" +
											"<tr><td>负责人联系电话</td><td>"+d.fzrlxdh+"</td><td>采集日期</td><td>"+d.cjrq+"</td></tr>");
							break;
                            ...
                            break;
                            default:$("#nodeInfo").html("<tr><td width='75px'>存款账户</td><td width='120%'>"+d.ckzh+"</td><td width='75px'>账户名称</td><td width='120%'>"+d.zhmc+"</td></tr>" +
                            				"<tr><td>证件号码</td><td>"+d.creditcode+"</td><td>客户统一编号</td><td>"+d.khtybh+"</td></tr>" +
                            				"<tr><td>银行机构名称</td><td>"+d.yxjgmc+"</td><td>银行机构代码</td><td>"+d.yxjgdm+"</td></tr>" +
                            				"<tr><td>保证金账户标志</td><td>"+d.bzjzhbz+"</td><td>存款余额</td><td>"+(d.ckye/10000)+"万元</td></tr>" +
                            				"<tr><td>币种</td><td>"+d.bz+"</td></tr>");
                            break;	
						}
						/*switch(d.label){
	        		...
	        		.on("mouseover",function(d,i){
						...
						switch (d.label){
                            ...
                            default:$("#nodeSize").html("存款账户： "+d.ckzh+" 账户名称："+d.zhmc+" 银行机构名称:"+d.yxjgmc);break;
						}
					})
		...
		//设置文本
		  var nodetext=nodetextd.enter()
					  ...
					  .attr("pointer-events", "none")
					  .text(function(d){
					  return (d.label=="B")?d.yxjgmc:((d.label=="P")?d.khxm:((d.label=="C")?d.khmc:d.zhmc));
					  });
					...
					.on("mousedown",function(d,i){
						...
						switch(d.label){
								case "DB":
									...
									break;
								case "JY":
                                    $("#nodeInfo").html("<tr><td width='75px'>关系类型</td><td width='120%'>"+maprel(d.label)+"</td><td width='75px'>交易账号</td><td width='120%'>"+d.jyzh+"</td></tr>" +
                                    		"<tr><td>对方行号</td><td>"+d.dfxh+"</td><td>核心交易流水号</td><td>"+d.hxjylsh+"</td></tr>" +
                                    		"<tr><td>笔次序号</td><td>"+d.bcxh+"</td><td>交易日期</td><td>"+d.jyrq+"</td></tr>" +
                                    		"<tr><td>银行机构代码</td><td>"+d.yxjgdm+"</td><td>交易机构名称</td><td>"+d.jyjgmc+"</td></tr>" +
                                    		"<tr><td>交易机构总行</td><td>"+d.jyjgmc_zh+"</td><td>明细科目编号</td><td>"+d.mxkmbh+"</td></tr>" +
                                    		"<tr><td>交易时间</td><td>"+d.jysj+"</td><td>交易机构名称</td><td>"+d.jyjgmc+"</td></tr>" +
                                    		"<tr><td>交易户名</td><td>"+d.jyhm+"</td><td>对方机构名称</td><td>"+d.dfjgmc+"</td></tr>" +
                                    		"<tr><td>对方账号</td><td>"+d.dfzh+"</td><td>对方户名</td><td>"+d.dfhm+"</td></tr>" +
                                    		"<tr><td>交易金额</td><td>"+(d.jyje/10000)+"万元</td><td>账户余额</td><td>"+(d.zhye/10000)+"万元</td></tr>" +
                                    		"<tr><td>交易借贷标志</td><td>"+d.jyjdbz+"</td><td>现转标志</td><td>"+d.xzbz+"</td></tr>" +
                                    		"<tr><td>币种</td><td>"+d.bz+"</td><td>业务类型</td><td>"+d.ywlx+"</td></tr>" +
                                    		"<tr><td>交易类型</td><td>"+d.jylx+"</td><td>交易渠道</td><td>"+d.jyqd+"</td></tr>" +
                                    		"<tr><td>交易介质号</td><td>"+d.jyjzh+"</td><td>操作柜员号</td><td>"+d.czgyh+"</td></tr>" +
                                    		"<tr><td>摘要</td><td>"+d.zy+"</td><td>账户标志</td><td>"+d.zhbz+"</td></tr>" +
                                    		"<tr><td>开销户标志</td><td>"+d.kxhbz+"</td><td>采集日期</td><td>"+d.cjrq+"</td></tr>");
                                    break;
								case "DK":
